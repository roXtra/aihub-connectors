...
dotnet restore .\roXtraAiHubOpenAIConnector\AiHub.Connector\AiHub.Connector.OpenAI.csproj -r win-x64
dotnet build .\roXtraAiHubOpenAIConnector\AiHub.Connector\AiHub.Connector.OpenAI.csproj --configuration Release -r win-x64 --no-restore
dotnet publish .\roXtraAiHubOpenAIConnector\AiHub.Connector\AiHub.Connector.OpenAI.csproj `
  -c Release -r win-x64 --no-build --no-restore `
  -p:PublishSingleFile=true `
  -p:SelfContained=false `
  -p:ContinuousIntegrationBuild=true `
  -o .\out\openai-win-x64
```
